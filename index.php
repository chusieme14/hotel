...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:3jnhotel@gmail.com">3jnhotel@gmail.com</a></li>
		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">3J-N <span>HOTEL</span><p class="logo_w3l_agile_caption">Your Dreamy Resort</p></a></h1>
				</div>
				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav class="menu menu--iris">
						<ul class="nav navbar-nav menu__list">
							...
							<li class="menu__item"><a href="#contact" class="menu__link scroll">Book Now</a></li>
						</ul>
					</nav>
				</div>
			</nav>
				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							...
							<span class="cbp-ig-category">3J-N</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
                            <h3 class="title-w3-agileits title-black-wthree">About Our 3J-N HOTEL</h3> 
						   ...
						   <img src="images/about.jpg" class="img-responsive" alt="Hair Salon">
                                       ...
                                       <div class="w3ls-info-about">
											...
											<p>Experience a good stay, enjoy fantastic offers! </p>
										</div>
		          </div>
		   	<div class="clearfix"> </div>
    </div>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:3jnhotel@gmail.com">3jnhotel@gmail.com</a></p>
			<p class="contact-agile1"><strong>Address :</strong> Calbayog City, Philippines</p>
...
<!-- /contact -->
			<div class="copy">
		        <p>© 2021 3J-N HOTEL.All Rights Reserved | Design by <a href="index.php">3J-N HOTEL</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
