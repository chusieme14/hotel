    ...
    <div id="wrapper">
        <nav class="navbar navbar-default top-navbar" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="frontdesk.php"> <?php echo $_SESSION["user"]; ?> </a>
            </div>
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu" href="frontdesk.php"><i class="fa fa-dashboard"></i> Status</a>
                    </li>
                    <li>
                        <a href="EditRoom.php"><i class="fa fa-desktop"></i> Edit Room</a>
                    </li>
					<li>
