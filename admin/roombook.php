                                    ...
                                    <tr>
										...
										<tr>
											...
											<select name="nroom" class="form-control" required>
												<option value="<?php echo $nroom; ?>" selected ><?php echo $nroom; ?></option>
												<?php
													include ('db.php');
													$sql="select * from room where  place = 'Free' AND not id =".$nroom;
													$re = mysqli_query($con,$sql);
													while($row = mysqli_fetch_array($re))
													{
														echo"
...
<?php
						...
						if(isset($_POST['update'])){
							$room = $_POST['nroom'];
							$urb = "UPDATE `roombook` SET NRoom = $room WHERE id = '$id'";
							mysqli_query($con,$urb);
							echo "<script type='text/javascript'> window.location='roombook.php?rid=".$id."'</script>";
						}
